...
COMMON_CONFIG += CC="/opt/cosmos/bin/cosmocc" 
# COMMON_CONFIG += CFLAGS="-static"
COMMON_CONFIG += CXX="/opt/cosmos/bin/cosmoc++"
...
GCC_CONFIG += --disable-lto --with-static-standard-libraries
GCC_CONFIG += --disable-libada --disable-libssp

# GCC_CONFIG += CFLAGS="-g3 -ggdb3"
# GCC_CONFIG += --without-mpc --with-mpfr=no --with-gmp=no --without-isl
